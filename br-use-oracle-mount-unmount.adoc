...
[.lead]
Mount an Oracle Database recovery point when you need access to the database in a controlled state for recovery operations. If automatic cataloging is disabled, you can manually catalog the recovery point metadata in the RMAN recovery catalog.
