...
+ 
* *Prescript*: Enter the full path for a script that should be run before the restore operation and any arguments that the script takes.
...
.. In the *Notification* section, consider the following options:
+
...
.. In the *Post restore options* section, consider the following options:
+
* *Start virtual machine*: Enable this option to boot the new virtual machine after it is restored.
