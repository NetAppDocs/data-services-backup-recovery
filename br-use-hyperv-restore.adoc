...
* Restore from an object storage backup (to original location only)

NOTE: Restore from object store backup is not supported for VMs that reside on SAN storage.
