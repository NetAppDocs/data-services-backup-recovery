...
summary: Create and manage protection groups for Oracle Database workloads in NetApp Backup and Recovery. 
---
...
[.lead]
Create protection groups to manage backup operations for Oracle Database resources. A protection group is a logical grouping of resources, such as databases, that you want to protect together.

You can perform the following tasks related to protection groups:

* Create a protection group.
* View protection details. 
* Back up a protection group now. See link:br-use-oracle-backup.html[Back up Oracle Database workloads now].
//* Suspend and resume a protection group's backup schedule.  
* Delete a protection group.

== Create a protection group 

Group Oracle Database resources that you want to protect together into a protection group.
...
. Select the databases that you want to include in the protection group.
. Select *Next*. 
