...
Documentation for each NetApp Backup and Recovery API is available from https://docs.netapp.com/us-en/bluexp-automation/cbs/overview.html[NetApp Console automation^].
