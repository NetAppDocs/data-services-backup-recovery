...
Refer to https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-setting-up-kms.html[Set up Amazon FSx for NetApp ONTAP to use a customer-managed key in AWS^].
