...
For details, refer to https://docs.netapp.com/us-en/bluexp-backup-recovery/br-start-licensing.html[Set up licensing for NetApp Backup and Recovery].
...
Refer to https://docs.netapp.com/us-en/bluexp-backup-recovery/br-start-login.html[Log in to NetApp Backup and Recovery] and https://docs.netapp.com/us-en/bluexp-backup-recovery/reference-roles.html[NetApp Backup and Recovery access to features].
