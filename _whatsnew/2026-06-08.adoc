...
* *Job monitor improvements*: Job monitoring now provides enhanced visibility into Kubernetes protection tasks. You can view detailed information about jobs, child tasks, statuses, and the target storage used by each.
