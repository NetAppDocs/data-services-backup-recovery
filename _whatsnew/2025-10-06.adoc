...
This release of NetApp Backup and Recovery introduces support for discovering and managing Hyper-V workloads:
...
This release of NetApp Backup and Recovery introduces support for discovering and managing KVM workloads:
