...
* *Restore to alternate location enhancements*: You can now restore to an alternate location from primary, secondary, and object store locations for VMs on SAN storage.
* *Restore CIFS files and folders*: You can now restore files and folders from backups stored on CIFS shares.
...
* *Clone support*: You can now create clones of primary and secondary snapshots.
