...
See the complete list of supported volumes in the https://docs.netapp.com/us-en/bluexp-backup-recovery/concept-backup-to-cloud.html[Learn about NetApp Backup and Recovery].
