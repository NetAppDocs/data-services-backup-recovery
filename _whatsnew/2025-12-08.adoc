...
* You can now restore VMware virtual disks (VMDK images) from either a primary or secondary location, enabling more granular control over restoring VM data.
