...
* *Support for dark sites* - You can now download Backup and Recovery for dark sites from the https://mysupport.netapp.com/site/products/all/details/netapp-console/downloads-tab/download/61906/4.4.0/downloads[NetApp Support Site]. At this time, the dark site release of NetApp Backup and Recovery supports only ONTAP Volumes workloads.
