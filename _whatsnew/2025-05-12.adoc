...
To begin using this preview feature, you must enable a flag on the Console agent. You can then enter the connection details of your MinIO third-party object store in the protection workflow by choosing *Third party Compatible* object store in the backup section. 
