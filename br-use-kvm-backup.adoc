...
* Create protection groups to manage the backup and restore operations for a set of resources. See link:br-use-kvm-protection-groups.html[Manage KVM protection groups in NetApp Backup and Recovery] for more information.
