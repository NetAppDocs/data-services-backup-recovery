...
[.lead]
In NetApp Backup and Recovery, you can back up volume data from your on-premises ONTAP systems to a secondary storage system and to Google Cloud Storage. Use this page to prepare your environment and activate backups.
...
+
If the Google Cloud Storage destination for your backups exists on the Console *Systems* page, you can drag the ONTAP cluster onto Google Cloud Storage.
...
+
* *Encryption key*: If you created a new Google Cloud Storage bucket, enter encryption key information given to you from the provider. Choose whether you'll use the default Google Cloud encryption keys, or choose your own customer-managed keys from your Google Cloud account, to manage encryption of your data.
+ 
NOTE: If you chose an existing Google Cloud Storage bucket, encryption information is already available, so you don't need to enter it now.
+ 
