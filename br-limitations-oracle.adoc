...
The following actions are not supported in the private preview version of Oracle workloads in NetApp Backup and Recovery: 
...
Oracle Database is only supported as a standalone deployment in the private preview version of Oracle workloads.
