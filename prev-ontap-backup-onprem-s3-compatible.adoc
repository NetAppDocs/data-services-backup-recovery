...
[.lead]
Use this page to verify that your configuration is supported and to configure backups from your primary on-premises ONTAP systems to S3-compatible object storage in NetApp Backup and Recovery.
