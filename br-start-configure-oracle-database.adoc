...
. *Configure RMAN catalog*: Choose where backup and recovery operation metadata is stored when automatic cataloging is enabled in the protection policy or when you manually catalog a recovery point:
+
