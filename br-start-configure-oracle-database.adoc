...
. *Configure RMAN catalog*: Set RMAN connection settings for the database. 
+
* Select *Target control file* to use the RMAN target control metadata file.
* Select *Catalog database* to use the RMAN recovery catalog. Choose the credentials and Transparent Network Substrate (TNS) name to connect to the recovery catalog.
