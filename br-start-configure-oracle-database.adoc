...
. *Configure RMAN catalog*: Choose where Oracle Recovery Manager (RMAN) catalog metadata is stored when cataloging is enabled in the protection policy or when you perform a manual catalog operation for a recovery point:
+
