...
. *Configure RMAN catalog*: Choose where metadata for backups and recovery operations is stored when automatic cataloging is enabled in the protection policy or when you manually catalog a recovery point:
+
