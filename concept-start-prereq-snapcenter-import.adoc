...
= SnapCenter import prerequisites for NetApp Backup and Recovery
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
[.lead]
Before you import resources from the SnapCenter Plug-in for Microsoft SQL Server into NetApp Backup and Recovery, make sure your environment meets these additional requirements.
...
To import resources from the SnapCenter Plug-in for Microsoft SQL Server, make sure the host requirements for installing the SnapCenter Plug-in for Microsoft SQL Server are met.
