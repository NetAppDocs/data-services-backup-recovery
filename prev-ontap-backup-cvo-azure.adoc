...
The Console agent can be installed in an Azure region with full or limited internet access ("standard" or "restricted" mode). https://docs.netapp.com/us-en/bluexp-setup-admin/concept-modes.html[See NetApp Console deployment modes for details^].
...
* https://docs.netapp.com/us-en/bluexp-setup-admin/task-quick-start-connector-azure.html[Deploy a Console agent in Azure in standard mode (full internet access)^]
