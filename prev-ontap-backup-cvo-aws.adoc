...
The Console agent must be installed in an AWS region with full or limited internet access ("standard" or "restricted" mode). https://docs.netapp.com/us-en/bluexp-setup-admin/concept-modes.html[See NetApp Console deployment modes for details^].
...
* https://docs.netapp.com/us-en/bluexp-setup-admin/task-quick-start-connector-aws.html[Deploy a Console agent in AWS in standard mode (full internet access)^]
* https://docs.netapp.com/us-en/bluexp-setup-admin/task-quick-start-restricted-mode.html[Install the Console agent in restricted mode (limited outbound access)^]
//* https://docs.netapp.com/us-en/bluexp-setup-admin/task-quick-start-private-mode.html[Install the Console agent in private mode (no internet access)^]
//
//[NOTE]
//====
//NetApp Backup and Recovery functionality is built into the Console agent. When installed in private mode, you'll need to update the Console agent software periodically to get access to new features. Check the link:whats-new.html[NetApp Backup and Recovery What's new] to see the new features in each NetApp Backup and Recovery release, and then you can follow the steps to https://docs.netapp.com/us-en/bluexp-setup-admin/task-upgrade-connector.html[upgrade the Console agent software^] when you want to use new features.
//
...
* Add the destination AWS account credentials in the Console. https://docs.netapp.com/us-en/bluexp-setup-admin/task-adding-aws-accounts.html#add-additional-credentials-to-a-connector[See how to do this^].
