...
NOTE: You can't delete individual volume backup files once the backup relationship has been deleted. You can, however, <<Delete all backup files for a volume>>.
...
NOTE: You can't delete individual volume backup files once the backup relationship has been deleted. You can, however, <<Delete all backup files for a volume>>. If you need to delete a backup relationship for a volume, make sure to delete the backups for the volume first, then delete the backup relationship.
