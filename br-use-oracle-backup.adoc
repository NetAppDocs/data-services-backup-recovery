...
* Create protection groups to manage the backup and restore operations for a set of resources. See link:br-use-kvm-protection-groups.html[Create and manage protection groups for Oracle Database workloads with NetApp Backup and Recovery] for more information.
