...
= Policy differences between SnapCenter and NetApp Backup and Recovery
:hardbreaks:
:icons: font
:imagesdir: ./media/

[.lead]
Use this reference to understand the policy differences between SnapCenter and NetApp Backup and Recovery that can affect imported resources and policies.
...
NetApp Backup and Recovery uses the following schedule tiers, which differ slightly:
...
NetApp Backup and Recovery adjusts SnapCenter schedules as follows:
