...
* Optionally, you can increase resiliency of Search & Restore by performing an additionaly step when you enable Search & Restore. For instructions, refer to <<mount-volume-steps,Mount the volume to reindex the catalog>>.
