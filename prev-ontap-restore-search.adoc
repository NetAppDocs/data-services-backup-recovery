...
[.lead]
You can use Search and Restore to recover volumes, folders, or files from ONTAP backup files. Search and Restore enables you to search across all backups (including local snapshots, replicated volumes, and object storage) without needing exact system, volume, or file names.
