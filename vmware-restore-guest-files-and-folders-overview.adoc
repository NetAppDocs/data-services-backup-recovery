---
sidebar: sidebar
permalink: vmware-restore-guest-files-and-folders-overview.html
keywords:
...
+
NetApp Backup and Recovery does not support searching of files or folders to restore. Therefore, before you begin you must know the location of the files or folders with respect to the snapshot and the corresponding VMDK.

* Virtual disk to be attached must be in a SnapCenter or NetApp Backup and Recovery backup.
+
