...
.. Choose whether to allow NetApp Backup and Recovery to install the plug-in automatically or skip the automatic plug-in installation (if you enable *Use manual installation*, you will need to manually install the plug-in on the each host).
