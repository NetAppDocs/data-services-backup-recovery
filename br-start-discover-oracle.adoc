...
+
If you choose credentials for a non-root user, The *Configure sudoers* link appears.

.. (Optional) For instructions on how to add the non-root user you have selected to the sudoers file on the Oracle Database host, select *Configure sudoers*.
