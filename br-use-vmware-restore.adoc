...
. Select the VM or VMs that you want to restore from. 
+
A list of snapshots created on that virtual machine appears.
...
+
Next, choose the destination settings and pre- and post-restore options.
...
** *Enable email notifications*: Select to get email notifications about the restore operation and choose the notification types you want.
