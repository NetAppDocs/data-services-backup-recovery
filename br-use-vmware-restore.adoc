...
** *Change default storage location*: Enable this option to restore an object store backup to a different storage VM in case the source storage location is unreachable or full. Choose a different cluster, storage VM, or aggregate to use.
* *Pre-restore options* section:
