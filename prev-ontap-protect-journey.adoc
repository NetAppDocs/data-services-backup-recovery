...
NOTE: When creating your own object store container in Azure, the container name must match the Azure storage account name. If the names don't match, the activation of NetApp Backup and Recovery fails.
