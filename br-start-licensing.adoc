...
* If you are using Backup and Recovery with NetApp Console, you can subscribe to the pay-as-you-go (PAYGO) license or purchase a bring-your-own-license (BYOL) license.
...
Set up licensing for the on-premises vesion of NetApp Console.
...
You use the NetApp Console local deployment to manage BYOL licenses. You can add new licenses, update existing licenses, and view license status from the Console.
