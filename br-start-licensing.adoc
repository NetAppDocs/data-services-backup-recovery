...
A NetApp Backup and Recovery 30-day free trial is available for all unlicensed workloads except ONTAP Volumes workloads. When you start using a workload (before you discover resources), you can start the free trial. After the free trial starts, the ongoing free trial and its used capacity is listed on the NetApp Backup and Recovery home page under *Free Trials*.
