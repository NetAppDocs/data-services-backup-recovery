...
= Restore Kubernetes applications with NetApp Backup and Recovery using a custom resource
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
* You can use advanced settings to customize restore operations. To learn more, refer to link:br-use-kubernetes-advanced-restore-settings.html[Advanced restore settings for Kubernetes in NetApp Backup and Recovery].
====
