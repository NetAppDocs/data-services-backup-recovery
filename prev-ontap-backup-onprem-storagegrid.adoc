...
[.lead]
In NetApp Backup and Recovery, you can back up volume data from your primary on-premises ONTAP systems to a secondary storage system and to StorageGRID object storage. Use this page to prepare your environment and activate backups.
