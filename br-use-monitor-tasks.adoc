...
https://review.docs.netapp.com/us-en/console-local_main/task-alerts-monitor.html#investigate-an-alert[Configure notification rules for alerts in NetApp Console (local deployment)^].
