...
. Expand the *Destination settings* section and choose to restore either to the default storage class or to map the storage classes to the destination cluster. 
