...
+
NOTE: If you need to create an AppVault on a Kubernetes cluster, refer to link:br-use-kubernetes-appvault-custom-resources.html[Create AppVault objects for compatibility with Trident Protect backups].
