...
+
NOTE: If you need to create an AppVault on a Kubernetes cluster to facilitate restoring a backup or snapshot created using Trident Protect, refer to link:br-use-kubernetes-appvault-custom-resources.html[Create AppVault objects for compatibility with Trident Protect backups].
