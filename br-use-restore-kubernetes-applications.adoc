...
. Optionally, if you are restoring from a cluster that was previously managed by Trident Protect, view the details of the AppVault used as the storage bucket for the restore operation. You can sync the AppVault to refresh the details.
