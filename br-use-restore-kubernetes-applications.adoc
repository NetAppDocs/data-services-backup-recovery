...
.. Enable the *Resource modifier* option to change the options.
.. Optionally select a template from the *Template* list. This list contains templates that you have created and are useful to quickly apply modifier settings that you commonly use.
+
