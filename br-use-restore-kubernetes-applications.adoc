...
.. Specify what target resource you want to modify by entering the resource group, version, kind, and name.
...
.. If applicable, enter a new value to use. The *Value* field only appears for certain operations (such as *Replace*).
