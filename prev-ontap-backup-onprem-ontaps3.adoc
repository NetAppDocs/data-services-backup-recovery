...
[.lead]
In NetApp Backup and Recovery, you can back up volume data from your primary on-premises ONTAP systems to ONTAP S3 and optionally to a secondary ONTAP system for replication. Use this page to prepare your environment and activate backups.
