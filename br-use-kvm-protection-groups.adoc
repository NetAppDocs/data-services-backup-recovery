...
= Manage KVM protection groups in NetApp Backup and Recovery
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
[.lead]
Create and manage protection groups so you can back up related KVM virtual machines and storage pools together.

You can do the following with protection groups:
...
Group the VMs and storage pools that you want to protect together into a protection group. 
...
+
The VMs that you select appear in the *Added virtual machines* area. You can remove individual VMs or clear the list. You can add VMs from multiple KVM hosts.
. Select *Next*. 
...
+
For more information, see link:br-use-policies-create.html[Create and manage policies].
. Select *Next*. 
