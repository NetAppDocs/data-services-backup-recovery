...
[.lead]
Clone Microsoft SQL Server application data for development, testing, or protection with NetApp Backup and Recovery. Create clones from instant or existing snapshots of your SQL Server workloads.
...
+
* *Clone refresh schedule and expiration*: If you choose *Instant clone*, enter the date when to begin refreshing the clone. The clone schedule defines when the clone is created.
