...
time zone of the management host. Refer to link:br-use-policies-hyper-v-create.html[Create and manage Hyper-V backup policies in NetApp Backup and Recovery] for more information.
...
. Select the *Protection groups* menu.
