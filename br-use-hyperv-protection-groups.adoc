...
. Change any settings for the protection group such as the name or what virtual machines are in the group.
. Select *Next*.
. Change the protection policy if needed. When finished, select *Next*.
