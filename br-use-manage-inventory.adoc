...
summary: NetApp Backup and Recovery helps you manage your Microsoft SQL Server hosts, databases, and instances.
---
...
[.lead]
NetApp Backup and Recovery helps you manage your Microsoft SQL Server hosts, databases, and instances. You can view, change, or remove protection settings for your inventory.    
