...
[.lead]
NetApp Backup and Recovery enables you to add Kubernetes applications through the web UI or by applying custom resource files. Applications can be namespace-based, composed of standard Kubernetes resources, or VM-based, composed of one or more virtual machines.
...
The first step in protecting Kubernetes applications is to create an application within NetApp Backup and Recovery. When you create an application, you make Backup and Recovery aware of the running application on the Kubernetes cluster.
