...
. Under *Filters*, choose to filter applications by namespace or by virtual machine.
+
NOTE: If you choose *Virtual machine*, you can build an application that consists of one or more virtual machines, enabling you to protect the virtual machine as you would any other application.
