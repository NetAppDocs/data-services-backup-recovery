...
.Add a namespace-based application using the web UI
...
.Add a VM-based application using the web UI
...
+
NOTE: If you enter label selectors, you cannot modify the list of virtual machines that are included in the application (the list is no longer interactive).
+
...
.Add a namespace-based application using a CR
