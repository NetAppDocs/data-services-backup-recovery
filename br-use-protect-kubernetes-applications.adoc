...
+
* *application.protect.trident.netapp.io/policy-name*: (_Optional_) The name of the protection policy that you want to use to protect this application. If you don't include this attribute, the application won't be protected by Backup and Recovery.
