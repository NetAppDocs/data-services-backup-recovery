...
= Troubleshoot VMware guest file restore in NetApp Backup and Recovery
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
[.lead]
If you encounter problems while restoring a guest file, use these scenarios to identify and correct the issue.
