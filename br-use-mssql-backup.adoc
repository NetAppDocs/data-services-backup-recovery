...
[.lead]
Back up Microsoft SQL Server application data from on-premises ONTAP systems to Amazon Web Services, Microsoft Azure, or StorageGRID. Backup and Recovery automatically creates backups and stores them in an object store in your cloud account for data protection. 
