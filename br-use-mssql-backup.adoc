...
summary: Back up Microsoft SQL Server application data from on-premises ONTAP systems to Amazon Web Services, Microsoft Azure, and StorageGRID to ensure that your data is protected.
---
...
[.lead]
Back up Microsoft SQL Server workloads from on-premises ONTAP systems to Amazon Web Services, Microsoft Azure, or StorageGRID.

* Create policies to back up workloads on a schedule and manage backup and restore operations. See link:br-use-policies-create.html[Create policies] for instructions.
* Configure the log directory for discovered hosts before starting a backup. 
* Create an on-demand backup to back up workloads immediately.  
...
*Required NetApp Console role*
Backup and Recovery super admin, Backup and Recovery backup admin, or Backup and Recovery restore admin role. If you are protecting data stored on a Cloud Volumes ONTAP cluster, the Cloud Volumes ONTAP Admin role is also required. Learn about link:reference-roles.html[Backup and Recovery roles and privileges]. https://docs.netapp.com/us-en/console-setup-admin/reference-iam-predefined-roles.html[Learn about NetApp Console access roles for all services^].
...
. Select the hosts or nodes on which you want to store the logs. 
+
...
+
If you want to create a policy, select *Create new policy* and follow the prompts. See link:br-use-policies-create.html[Create policies] for more information.
. Select *Next*. 
...
. Select a workload to view the protection details. 
. Select the Actions icon image:../media/icon-action.png[Actions option] > *View details*.   
. Select the *Protection groups*, *Availability groups*, *Instances*, or *Databases* tab. 
...
. Select the policy to apply to the backup.
...
. Select a workload to view the protection details. 
. Select the Actions icon image:../media/icon-action.png[Actions option] > *View details*.   
. Select the *Protection groups*, *Instances*, or *Databases* tab. 
