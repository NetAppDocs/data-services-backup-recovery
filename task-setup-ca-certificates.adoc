...
= Set up security certificates for NetApp Backup and Recovery
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
If the communication between NetApp Backup and Recovery containers and StorageGRID should verify the StorageGRID certificate, then complete the following steps. 
