...
summary: Prepare an offsite location, such as StorageGRID, AWS, or Azure, and configure the required permissions so it can serve as a backup destination.
---
...
* NetApp StorageGRID. 
+
See https://docs.netapp.com/us-en/storage-management-storagegrid/task-discover-storagegrid.html[Discover StorageGRID^].
+
See https://docs.netapp.com/us-en/storagegrid/index.html[StorageGRID documentation^] for details about StorageGRID. 

* Amazon Web Services. See https://docs.netapp.com/us-en/storage-management-s3-storage/index.html[Amazon S3 documentation^].
+
...
** For details about managing your AWS storage in the Console, see https://docs.netapp.com/us-en/console-setup-admin/task-viewing-amazon-s3.html[Manage your Amazon S3 buckets^].

* Microsoft Azure.
** See https://docs.netapp.com/us-en/storage-management-blob-storage/index.html[Azure Blob storage documentation^].
...
** For details about managing your Azure storage in the Console, see https://docs.netapp.com/us-en/storage-management-blob-storage/task-view-azure-blob-storage.html[Manage your Azure storage accounts^].


After you configure options in the backup destination itself, you will later configure it as a backup destination in NetApp Backup and Recovery. For details about how to configure the backup destination in NetApp Backup and Recovery, see link:br-start-discover-backup-targets.html[Discover backup targets].
...
+ 
See the https://docs.aws.amazon.com/IAM/latest/UserGuide/id_roles_create_for-user.html[AWS Documentation: Creating a Role to Delegate Permissions to an IAM User^].
