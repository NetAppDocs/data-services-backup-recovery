...
== Supported workloads, backup sources, and backup targets
...
* ONTAP volumes 
* Microsoft SQL Server instances and databases, VMware Virtual Machine File System (VMFS), and VMware Virtual Machine Disk (VMDK) NFS 
