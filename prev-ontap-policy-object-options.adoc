...
[.lead]
Use backup-to-object policies in NetApp Backup and Recovery to define schedules, retention, DataLock, ransomware protection, and archival settings for your on-premises ONTAP and Cloud Volumes ONTAP systems.
...
//ifdef::azure[]
* For Azure:
** Your clusters must be running ONTAP 9.12.1 or greater
** The Console agent can be deployed in the cloud or on your premises
//endif::azure[]
//ifdef::gcp[]
* For Google Cloud:
