...
[.lead]
Use NetApp Backup and Recovery to create Microsoft SQL Server backup policies that control backup frequency, schedule, and retention.
...
Backup and Recovery super admin or Backup and Recovery backup admin. https://docs.netapp.com/us-en/console-setup-admin/reference-iam-predefined-roles.html[Learn about NetApp Console access roles for all services^].
