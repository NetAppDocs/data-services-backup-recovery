...
. Choose an installation type to view the instructions for installing Trident Protect and the Trident Protect Connector on your Kubernetes cluster:
* Select "Normal" to discover clusters that have external network connectivity.
...
. Follow the command line instructions that appear. These steps ensure that NetApp Backup and Recovery can interact with the cluster.
