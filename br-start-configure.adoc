...
* <<Create a resource modifier template>> to modify resources as you restore them.
...
== Create a resource modifier template
Create resource modifier templates to store common transformations you make to resources as you restore them. 
...
. Enter a name for the resource modifier template.
