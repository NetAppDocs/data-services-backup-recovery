...
[.lead]
In NetApp Backup and Recovery, create your own Hyper-V backup policies that govern backup frequency, the time the backup is taken, and the number of backup files that are retained. 
