...
. From the Inventory page, select the imported SnapCenter host that you want NetApp Backup and Recovery to manage.
...
. From the Discover resources page, continue to Advanced Settings by selecting the down arrow on the right. 
...
. If you want to install the SnapCenter agent manually, select the following options:
* *Use manual installation*: Select this option to install the plug-in manually.   
//* *Use Group Managed Service Account (gMSA)*: If you use a specific third-party gMSA account to manage host credentials, select this option. 
...
//* *Skip automated installation*: Select this option to skip the automated installation of the plug-in. You might want to do this if you are installing the plug-in manually.
