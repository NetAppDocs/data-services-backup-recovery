...
. Provide information for the *Local snapshot settings*:
+
...
+
NOTE: The fields that appear differ depending on the provider and architecture selected. These settings are called "Backup settings" for Kubernetes workloads.
+
