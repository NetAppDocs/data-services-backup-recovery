...
+
Organization admins or Folder/project admins add Console users to projects with workloads. Assign users the Organization viewer role and a Backup and Recovery role based on their access needs. Users with the appropriate Backup and Recovery role will automatically gain access to new workloads in these projects.
