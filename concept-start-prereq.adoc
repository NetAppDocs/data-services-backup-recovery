...
You access NetApp Backup and Recovery through NetApp Console. Configuring the Console so that you can use Backup and Recovery includes adding a Console agent, adding at least one storage system, and configuring a Console organization and user roles.
...
=== Configure organizations and user roles
You need to have the Organization admin or Super admin role in NetApp Console to configure it for Backup and Recovery. Learn about organizations and user roles, and configure users with appropriate permissions to perform their tasks.

Refer to https://docs.netapp.com/us-en/console-setup-admin/task-iam-manage-members-permissions.html[Add users to a NetApp Console organization] for information about using organizations for resource access.

Refer to link:reference-roles.html[NetApp Backup and Recovery roles in NetApp Console] for details about the roles and permissions required to perform operations in NetApp Backup and Recovery.


== Requirement for ONTAP 9.8 and later
