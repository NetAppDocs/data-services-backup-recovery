...
** If users that are not part of an administrator domain will be protecting Hyper-V VMs using Backup and Recovery, ensure that the user has the following permission changes:
