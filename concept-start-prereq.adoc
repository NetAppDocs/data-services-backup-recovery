...
|8.0.23 Hosting Bundle (and all subsequent 8.0.x patches)
...
* ONTAP 9.13.1 or later
* Amazon FSx for NetApp ONTAP storage systems running version 9.13.1 or later
* SAN storage (preview) (supported for backups and restoring to original location from primary and secondary storage)
|===
