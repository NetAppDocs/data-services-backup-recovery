...
You access NetApp Backup and Recovery through NetApp Console. Configuring the Console so that you can use Backup and Recovery includes adding a Console agent, adding at least one storage system, and configuring a Console organization and user roles. You need to have the Organization admin or Super admin role in NetApp Console to prepare it for Backup and Recovery. 
...
Learn about organizations, projects, and user roles, and configure users with appropriate permissions to perform their tasks.

Refer to https://docs.netapp.com/us-en/console-setup-admin/task-iam-manage-members-permissions.html[Add users to a NetApp Console organization] for information about using an organization for resource access.
