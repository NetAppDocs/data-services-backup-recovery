...
You access NetApp Backup and Recovery through NetApp Console. There are things you need to do to prepare the Console for Backup and Recovery, depending on if you are using NetApp Console (service) or NetApp Console (local deployment).
...
To learn more about NetApp Console (local deployment), refer to https://docs.netapp.com/us-en/console-setup-admin/concept-overview.html[NetApp Console for unified storage management^].
...
==== Configure an organization and user roles
Learn about organizations and user roles, then configure users with the appropriate permissions needed to perform their tasks.
