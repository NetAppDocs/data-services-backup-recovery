...
== Requirements for NetApp Console
Configuring Console for Backup and Recovery includes adding a Console agent, adding at least one storage system, and assigning Console users the required organizations and roles to use Backup and Recovery.
