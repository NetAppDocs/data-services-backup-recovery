...
You access NetApp Backup and Recovery through NetApp Console. Perform these tasks to prepare the Console for Backup and Recovery, depending on if you are using NetApp Console (service) or NetApp Console local deployment.

=== Prepare NetApp Console (service)
To prepare NetApp Console (service) for Backup and Recovery, you must:
...
To learn more about NetApp Console (service), refer to https://docs.netapp.com/us-en/console-setup-admin/concept-overview.html[NetApp Console for unified storage management^].

==== Complete initial NetApp Console (service) setup
Complete the initial setup for NetApp Console (service) if you haven't already.

https://docs.netapp.com/us-en/console-setup-admin/task-quick-start-standard-mode.html[Getting started workflow for NetApp Console (service)^]
...
=== Prepare NetApp Console local deployment
To prepare NetApp Console local deployment for Backup and Recovery, you must:
