...
* Create protection groups to manage the backup and restore operations for a set of resources. See link:br-use-hyperv-protection-groups.html[Create and manage Hyper-V protection groups in NetApp Backup and Recovery] for more information.
