...
//Use CoreDNS to map a specific hostname to an IP address within the cluster.
...
.. Verify that the resulting HelmChartConfig file keeps the original tuning and now includes the `servers:` block.
