...
NOTE: After adding a storage system to NetApp Console, wait a few minutes before discovering KVM resources. Discovering resources immediately after adding a storage system can cause the discovery to fail.
