...
Monitor the restore in the *Job Monitor*; it completes when the job reaches a final status, such as *Completed* or *Failed*, after all retry attempts. Don't start another restore unless the job ultimately fails.
=====
