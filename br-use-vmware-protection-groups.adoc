...
* Be aware that for VMware workloads, the scheduled backup time is interpreted in the
time zone of the management host. Refer to link:br-use-policies-vmware-create.html[Create and manage VMware backup policies in NetApp Backup and Recovery] for more information.
