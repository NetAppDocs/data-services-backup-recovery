...
* *Manually select the spanning datastores to be included*: Manually select which spanning datastores to include in the protection group. This selection is static; you must update the list of spanning datastores each time new VMs are added to the group.
. Select *Next*.
